...
| 模型名称 | 类型 | 支持语言 | 标点 | 时间戳 | 下载地址 |
| ---- | ---- | ---- | ---- | ---- | ---- |
| parakeet-tdt_ctc-0.6b-ja-onnx | 非流式 | 日语 | **是** | 是 | [modelscope](https://www.modelscope.cn/models/manyeyes/parakeet-tdt_ctc-0.6b-ja-onnx) |
| parakeet-tdt_ctc-0.6b-ja-int8-onnx | 非流式 | 日语 | **是** | 是 | [modelscope](https://www.modelscope.cn/models/manyeyes/parakeet-tdt_ctc-0.6b-ja-int8-onnx) |
...
## v1.0/zh/models/asr/cohere-transcribe.md
