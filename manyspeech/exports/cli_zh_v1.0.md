## v1.0/zh/cli/getting-started/index.md
...
- [第一次使用](./first-use) - 首个识别示例


---

## v1.0/zh/cli/getting-started/installation.md
...
1. 下载最新安装包：  
   [manyspeech-cli-1.0.0-preview.9.17-win-x64-setup.exe](https://modelscope.cn/models/manyeyes/manyspeech-cli/resolve/master/manyspeech-cli-1.0.0-preview.9.17-win-x64-setup.exe)

2. 双击运行安装程序，按向导提示完成安装。

3. 安装完成后，打开 **命令提示符(cmd)** 或 **PowerShell**，输入以下命令验证：
...
1. 下载绿色版压缩包：  
   [manyspeech-cli-1.0.0-preview.9.17-win-x64.zip](https://modelscope.cn/models/manyeyes/manyspeech-cli/file/view/master/manyspeech-cli-1.0.0-preview.9.17-win-x64.zip)

2. 解压到任意目录（例如 `D:\Tools\ManySpeech`）。

3. 进入该目录，双击 `manyspeech-cli.exe` 即可运行。
...
## v1.0/zh/cli/getting-started/first-use.md
...
## v1.0/zh/cli/usage/cli-modes.md
...
## v1.0/zh/cli/usage/debugging.md
...
## v1.0/zh/cli/configuration/index.md
...
## v1.0/zh/cli/configuration/file-location.md
...
## v1.0/zh/cli/configuration/fields.md
...
## v1.0/zh/cli/configuration/commands.md
...
## v1.0/zh/cli/models/supported-models.md
...
## v1.0/zh/cli/models/auto-download.md
...
## v1.0/zh/cli/models/manual-specify.md
...
## v1.0/zh/cli/advanced/index.md

# 高级用法

本章节介绍 ManySpeech-CLI 的高级配置和集成技巧。

## 内容概览

- [环境变量配置](./environment-vars) - 通过环境变量预设参数
- [批量处理脚本](./batch-processing) - 自动化批量识别
- [性能优化](./performance) - 调优推理速度和精度
...
## v1.0/zh/cli/advanced/environment-vars.md
...
## v1.0/zh/cli/advanced/batch-processing.md
...
## v1.0/zh/cli/advanced/performance.md
...
## v1.0/zh/cli/reference/index.md
...
- [完整参数说明](./parameters) - 所有命令行参数的详细说明
...
## v1.0/zh/cli/reference/parameters.md
...
## v1.0/zh/cli/reference/changelog.md
