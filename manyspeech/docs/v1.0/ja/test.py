...
# 文件路径与内容的映射（已根据原文逐一手动提取）
files_content = {
    "docs/v1.0/ja/cli/usage/index.md": """# 使用ガイド
...
- [デバッグ](./debugging)
""",
    "docs/v1.0/ja/cli/usage/examples.md": """# 典型的な使用例
...
```
""",
    "docs/v1.0/ja/cli/usage/debugging.md": """# デバッグモード
...
""",
    "docs/v1.0/ja/cli/usage/commands.md": """# サブコマンド詳細
...
| `txt` | テキスト（デフォルト） |
""",
    "docs/v1.0/ja/cli/configuration/index.md": """# 設定管理
...
- [設定管理コマンド](./commands)
""",
    "docs/v1.0/ja/cli/configuration/file-location.md": """# 設定ファイルの配置
...
""",
    "docs/v1.0/ja/cli/configuration/fields.md": """# 設定フィールド説明
...
""",
    "docs/v1.0/ja/cli/configuration/commands.md": """# 設定管理コマンド
...
```
""",
    "docs/v1.0/ja/cli/reference/index.md": """# 参考資料
...
```
""",
    "docs/v1.0/ja/cli/reference/parameters.md": """# 全パラメータ説明
...
""",
    "docs/v1.0/ja/cli/reference/changelog.md": """# 更新ログ
...
- `manyspeech-cli` を初公開
""",
    "docs/v1.0/ja/cli/getting-started/index.md": """# クイックスタート
...
- [初回利用](./first-use)
""",
    "docs/v1.0/ja/cli/getting-started/installation.md": """# インストールガイド
...
ダウンロード候補:
- ModelScope ミラー: manyspeech-cli-1.0.0-preview.9.17-win-x64-setup.exe
- GitHub Releases: manyspeech-cli-1.0.0-preview.9.17-win-x64-setup.exe
...
ダウンロード候補:
- ModelScope ミラー: manyspeech-cli-1.0.0-preview.9.17-win-x64.zip
- GitHub Releases: manyspeech-cli-1.0.0-preview.9.17-win-x64.zip
...
```
""",
    "docs/v1.0/ja/cli/getting-started/first-use.md": """# 初回の使い方
...
```
""",
    "docs/v1.0/ja/cli/advanced/index.md": """# 高度な使い方
...
- カスタムワークフロー
""",
    "docs/v1.0/ja/cli/advanced/environment-vars.md": """# 環境変数の設定
...
""",
    "docs/v1.0/ja/cli/advanced/batch-processing.md": """# バッチ処理スクリプト
...
```
""",
    "docs/v1.0/ja/cli/advanced/performance.md": """# パフォーマンス最適化
...
""",
    "docs/v1.0/ja/cli/models/index.md": """# モデル管理
...
""",
    "docs/v1.0/ja/cli/models/supported-models.md": """# サポートモデル一覧
...
""",
    "docs/v1.0/ja/cli/models/auto-download.md": """# 自動ダウンロードの仕組み
...
""",
    "docs/v1.0/ja/cli/models/manual-specify.md": """# 手動でモデルを指定する
