...
- [Installation](/manyspeech/en/cli/getting-started/installation.md) - Detailed installation instructions
- [First Use](/manyspeech/en/cli/getting-started/first-use.md) - Your first recognition example
