...
cohere-transcribe-03-2026 模型基于 **500,000 小时人工筛选高质量音文配对数据集** 完成从零训练，并引入 0–30dB 信噪比区间的合成噪声数据进行泛化增强。

该训练数据规模参数是由研发团队在模型发布周期内**对外公开披露**，经 AI Wiki 行业权威技术综述收录、交叉核验后成为公开可查的标准化参数。

截至当前，Cohere 官方未公开数据集细分构成、语种配比、公开数据与私有数据占比及样本筛选细则。

### 参考文献（GB/T 7714 规范）

\[1] AI Wiki. Cohere Transcribe\[EB/OL]. (2026-03-27)\[2026-09-24]. [https://aiwiki.ai/wiki/cohere\_transcribe](https://aiwiki.ai/wiki/cohere_transcribe).
